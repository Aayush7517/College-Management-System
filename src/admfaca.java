 ...
 */
public class admfaca extends javax.swing.JFrame {

    /**
     * Creates new form admfaca
     */
    public admfaca() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText(" VIEW FACULTY DETAIL ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NAME", "DESIGNATION", "MOBILE", "GRADUATION", "POST_GRADUATION", "EMAIL", "EXPERIENCE", "GENDER", "ACHIVEMENTS", "BRANCH", "ADDRESS", "LOGIN", "PASSWORD"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
        ...
        try {
           ...
           ResultSet rs = stmt.executeQuery("Select * from facultydata");
            while(rs.next()) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            Connection conn = DriverManager.getConnection(url);
            Statement stmt = conn.createStatement();
            String querry = "SELECT name,designation,mobile,graduation,post_graduation,email,experience,gender,achivements,branch,address,login,password from facultydata WHERE name='" + filter + "';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admfaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
